                ...
                <div class="portfolio-actions">
                    ...
                    <label for="portfolio_image" style="cursor:pointer; display:inline-block;">
                        <span style="font-size:32px; color:#3498db; vertical-align:middle;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#3498db"
                                viewBox="0 0 24 24">
                                <path d="M19 19H5V5h7V3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7z" />
                                <path
                                    d="M21 1h-6c-.55 0-1 .45-1 1s.45 1 1 1h3.59l-9.83 9.83c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0L20 3.41V7c0 .55.45 1 1 1s1-.45 1-1V2c0-.55-.45-1-1-1z" />
                            </svg>
                        </span>
                        <span style="margin-left:8px; color:#3498db; font-weight:500; vertical-align:middle;"></span>
                        <input type="file" name="portfolio_image" id="portfolio_image" accept="image/*" required
                            style="display:none;">
                    </label>
                </div>
